...
function proceedToConfirmation() {
    ...
    const selectedPlaceName = document.getElementById('detailsTitle').innerText;
    ...
    // Getting image, title, and rating for the confirmation
    ...
    const rating = encodeURIComponent(document.getElementById('detailsRating').innerText);
